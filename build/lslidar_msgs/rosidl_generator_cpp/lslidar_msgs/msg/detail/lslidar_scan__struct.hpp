...
struct LslidarScan_
{
  ...
  using _points_type =
    std::vector<lslidar_msgs::msg::LslidarPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<lslidar_msgs::msg::LslidarPoint_<ContainerAllocator>>::other>;
  _points_type points;
  ...
  Type & set__points(
    const std::vector<lslidar_msgs::msg::LslidarPoint_<ContainerAllocator>, typename ContainerAllocator::template rebind<lslidar_msgs::msg::LslidarPoint_<ContainerAllocator>>::other> & _arg)
  {
    this->points = _arg;
    return *this;
  }
