...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cartographer/mapping/proto/3d/hybrid_grid.proto", schemas, file_default_instances, TableStruct::offsets,
...
const HybridGrid& HybridGrid::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cartographer_2fmapping_2fproto_2f3d_2fhybrid_5fgrid_2eproto::scc_info_HybridGrid.base);
