...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cartographer/mapping/proto/3d/range_data_inserter_options_3d.proto", schemas, file_default_instances, TableStruct::offsets,
...
const RangeDataInserterOptions3D& RangeDataInserterOptions3D::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cartographer_2fmapping_2fproto_2f3d_2frange_5fdata_5finserter_5foptions_5f3d_2eproto::scc_info_RangeDataInserterOptions3D.base);
