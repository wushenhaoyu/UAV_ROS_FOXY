...
static void InitDefaultsOptimizationProblemOptions() {
...
::google::protobuf::internal::SCCInfo<1> scc_info_OptimizationProblemOptions =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsOptimizationProblemOptions}, {
      &protobuf_cartographer_2fcommon_2fproto_2fceres_5fsolver_5foptions_2eproto::scc_info_CeresSolverOptions.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_OptimizationProblemOptions.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cartographer/mapping/proto/pose_graph/optimization_problem_options.proto", schemas, file_default_instances, TableStruct::offsets,
...
const OptimizationProblemOptions& OptimizationProblemOptions::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cartographer_2fmapping_2fproto_2fpose_5fgraph_2foptimization_5fproblem_5foptions_2eproto::scc_info_OptimizationProblemOptions.base);
...
void OptimizationProblemOptions::SerializeWithCachedSizes(
  ...
  if (this->has_ceres_solver_options()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      7, this->_internal_ceres_solver_options(), output);
  }
  ...
  if (this->has_ceres_solver_options()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        7, this->_internal_ceres_solver_options(), deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::cartographer::mapping::optimization::proto::OptimizationProblemOptions* Arena::CreateMaybeMessage< ::cartographer::mapping::optimization::proto::OptimizationProblemOptions >(Arena* arena) {
