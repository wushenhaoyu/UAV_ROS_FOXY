...
static void InitDefaultsProbabilityGrid() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_ProbabilityGrid =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsProbabilityGrid}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_ProbabilityGrid.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cartographer/mapping/proto/2d/probability_grid.proto", schemas, file_default_instances, TableStruct::offsets,
...
const ProbabilityGrid& ProbabilityGrid::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cartographer_2fmapping_2fproto_2f2d_2fprobability_5fgrid_2eproto::scc_info_ProbabilityGrid.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::cartographer::mapping::proto::ProbabilityGrid* Arena::CreateMaybeMessage< ::cartographer::mapping::proto::ProbabilityGrid >(Arena* arena) {
