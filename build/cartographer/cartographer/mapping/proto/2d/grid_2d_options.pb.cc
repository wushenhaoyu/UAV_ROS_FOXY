...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "cartographer/mapping/proto/2d/grid_2d_options.proto", schemas, file_default_instances, TableStruct::offsets,
...
const GridOptions2D& GridOptions2D::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_cartographer_2fmapping_2fproto_2f2d_2fgrid_5f2d_5foptions_2eproto::scc_info_GridOptions2D.base);
